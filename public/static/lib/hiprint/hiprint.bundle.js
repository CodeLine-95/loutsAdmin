...
var hiprint = function (t) {
            ...
            return t.prototype.init = function (t) {
                ...
                get: function get() {
                    return t._instance || (t._instance = new t(), window.HIPRINT_CONFIG && $.extend(t._instance, HIPRINT_CONFIG), t._instance.optionItems && t._instance.optionItems.forEach(function (t) {
                        console.log(t), i.a.registerItem(t);
                    })), t._instance;
                },
                enumerable: !0,
                configurable: !0
    ...
    var _entity_PrintElementEntity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17),
        ...
        _PrintReferenceElement__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7),
    ...
    var i = function () {
        ...
        u = function () {
            return function (t) {
                this.title = t.title, this.field = t.field, this.width = t.width, this.align = t.align, this.vAlign = t.vAlign, this.colspan = t.colspan, this.rowspan = t.rowspan, this.checked = t.checked, this.columnId = t.columnId, this.formatter2 = t.formatter2, this.styler2 = t.styler2;
            };
        }(),
        d = function () {
            function t() {
    ...
    var _ReconsitutionTableColumns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19),
        ...
        TableExcelHelper = function () {
            ...
            return TableExcelHelper.createTableHead = function (t, e) {
            ...
            }, TableExcelHelper.createTableFooter = function (t, e, n, i, o) {
                var r = $("<tfoot></tfoot>"),
                    a = this.getFooterFormatter(n, i);
                return a && r.append(a(n, e, o)), r;
                ...
                for (var o = function o(e) {
                    i.totalLayer = e + 1, i[e] = t[e].columns;
                    var n = 0;
                    t[e].columns.forEach(function (t) {
                        0 == e && (i.colspan += t.colspan), n += t.colspan, t.colIndex = e + n;
                ...
                return i.rowColumns = _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_1__.a.orderBy(i.rowColumns, function (t) {
                    return t.colIndex;
                }), i;
    ...
    var wt = function () {
        ...
        }, t._printElementOptionItems = [new o(), new r(), new a(), new p(), new i(), new s(), new l(), new pt(), new u(), new d(), new c(), new h(), new f(), new g(), new m(), new v(), new y(), new b(), new E(), new T(), new P(), new _(), new w(), new x(), new C(), new O(), new H(), new I(), new D(), new R(), new M(), new S(), new B(), new F(), new L(), new A(), new z(), new k(), new st(), new N(), new V(), new W(), new j(), new U(), new K(), new q(), new G(), new X(), new Y(), new Q(), new J(), new Z(), new tt(), new et(), new nt(), new it(), new ot(), new at(), new lt(), new ut(), new dt(), new ct(), new ht(), new ft(), new gt(), new mt(), new vt(), new yt(), new bt(), new Tt(), new Et(), new Pt(), new _t()], t;
    }();
}, function (t, e, n) {
    "use strict";
    ...
    var _BasePrintElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4),
        ...
        _PrintReferenceElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7),
        _option_TablePrintElementOption__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(18),
        _table_TableExcelHelper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8),
        ...
        TablePrintElement = function (_super) {
            function TablePrintElement(t, e) {
                ...
                return n.options = new _option_TablePrintElementOption__WEBPACK_IMPORTED_MODULE_5__.a(e, n.printElementType), n.options.setDefault(new _option_TablePrintElementOption__WEBPACK_IMPORTED_MODULE_5__.a(_HiPrintConfig__WEBPACK_IMPORTED_MODULE_1__.a.instance.table.default).getPrintElementOptionEntity()), n;
            }
            ...
            return __extends(TablePrintElement, _super), TablePrintElement.prototype.getColumns = function () {
                ...
                return o && e.append(o(this.options, this.getData(t), t)), new _table_GridColumnsStructure__WEBPACK_IMPORTED_MODULE_8__.a(this.options.getGridColumns(), e);
                ...
                return o.append(_table_TableExcelHelper__WEBPACK_IMPORTED_MODULE_6__.a.createTableHead(this.getColumns(), this.options.getWidth() / this.options.getGridColumns())), o.append(_table_TableExcelHelper__WEBPACK_IMPORTED_MODULE_6__.a.createTableRow(this.getColumns(), t, this.options, this.printElementType)), this.getFooterFormatter() && o.append(_table_TableExcelHelper__WEBPACK_IMPORTED_MODULE_6__.a.createTableFooter(this.printElementType.columns, t, this.options, this.printElementType, e)), o;
                ...
                for (var a, p = this.getBeginPrintTopInPaperByReferenceElement(t), s = 0, l = !1; !l;) {
                    ...
                    var c = n.length > 0 ? n[n.length - 1].target : void 0,
                        h = this.getRowsInSpecificHeight(u > 0 ? u : 0 == s ? d - p : t.getContentHeight(s), r, o, s, c);
                    l = h.isEnd;
                    var f = void 0;
                ...
                return n;
            }, TablePrintElement.prototype.getRowsInSpecificHeight = function (t, e, n, i, o) {
                var r = n.find("tbody"),
                    a = _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_3__.a.pt.toPx(t);

                e.find(".hiprint-printElement-tableTarget tbody").html("");
                var p = e.outerHeight();
                if (p > a) return {
                    target: void 0,
                    length: 0,
                ...
                for (var s = 0; s < this.options.getGridColumns(); s++) {
                    for (var l = e.find(".hiprint-printElement-tableTarget:eq(" + s + ")"), u = void 0; ;) {
                        if (p <= a) if (0 == r.find("tr").length) u = {
                            height: _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_3__.a.px.toPt(p),
                            isEnd: !0
                        }; else {
                            var d = r.find("tr:lt(1)");
                            l.find("tbody").append(d), (p = e.outerHeight()) > a && (r.prepend(d), p = e.outerHeight(), u = {
                                height: _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_3__.a.px.toPt(p),
                                isEnd: !1
                            });
                        }
                ...
                var c = e.find(".hiprint-printElement-tableTarget tbody tr").length;
                return 0 == r.find("tr").length ? 0 == c && o ? {
                    target: void 0,
                    length: 0,
                    height: 0,
                    isEnd: !0
    ...
    var i = n(3),
        ...
        r = (function () { }(), function () {
            return function (t) {
                this.width = t.width, this.title = t.title, this.columnId = t.columnId, this.fixed = !1, this.rowspan = t.rowspan || 1, this.colspan = t.colspan || 1, this.align = t.align, this.vAlign = t.vAlign, this.formatter2 = t.formatter2, this.styler2 = t.styler2;
            };
        }()),
        a = n(5);
    n.d(e, "a", function () {
    ...
    var _p,
        ...
        l = function (t) {
            function e(e, n) {
                var i = this;
                (e = e || {}, i = t.call(this, e) || this, n) && (i.columns = [], n.editable && e.columns && e.columns.length ? e.columns.forEach(function (t) {
                    var e = [];
                    t.forEach(function (t) {
                        var i = new r(t),
    ...
    var _r,
        ...
        W = function () {
            ...
            return t.createPrintElement = function (t, e) {
                return "text" == t.type ? new I(t, e) : "image" == t.type ? new v(t, e) : "longText" == t.type ? new w(t, e) : "table" == t.type ? new d.a(t, e) : "html" == t.type ? new S(t, e) : "vline" == t.type ? new F(t, e) : "hline" == t.type ? new A(t, e) : "rect" == t.type ? new k(t, e) : "oval" == t.type ? new V(t, e) : void 0;
            }, t;
        }(),
        j = function () {
            function t(t) {
        ...
        G = function (t) {
            ...
            return q(e, t), e.prototype.getPrintElementOptionEntity = function () {
                var e = t.prototype.getPrintElementOptionEntity.call(this);
        ...
        J = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new G(n), i.options.setDefault(new G(p.a.instance.tableCustom.default).getPrintElementOptionEntity()), i.columns = i.options.columns, i;
            }
            ...
            return Y(e, t), e.prototype.updateDesignViewFromOptions = function () {
                ...
                return n.append(X.a.createTableHead(this.columns, this.options.getWidth())), n.append(X.a.createTableRow(this.columns, t, this.options, this.printElementType)), this.printElementType.footerFormatter && n.append(X.a.createTableFooter(this.printElementType.columns, t, this.options, this.printElementType, e)), n;
            }, e.prototype.getHtml = function (t, e) {
                this.setCurrenttemplateData(e), this.createTempContainer();
                var n = this.getPaperHtmlResult(t, e);
                return this.removeTempContainer(), n;
                ...
                return n;
            }, e.prototype.getRowsInSpecificHeight = function (t, e, n, i, r) {
                var a = void 0,
                    p = n.find("tbody"),
                    s = o.a.pt.toPx(t);
                e.find("tbody").html("");

                for (var l = e.outerHeight(); ;) {
                    if (l <= s) {
                        if (0 == p.find("tr").length) {
                            a = {
                                target: e.clone(),
                                length: e.find("tbody tr").length,
                                height: o.a.px.toPt(l),
                                isEnd: !0
                            ...
                            e.find("tbody").append(u), (l = e.outerHeight()) > s && (p.prepend(u), l = e.outerHeight(), a = {
                                target: e.clone(),
                                length: e.find("tbody tr").length,
                                height: o.a.px.toPt(l),
                                isEnd: !1
