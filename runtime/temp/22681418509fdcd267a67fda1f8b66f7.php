<?php /*a:2:{s:72:"/www/wwwroot/pt.mbacms.com/application/admin/view/storage/returnNew.html";i:1582470425;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
...
this.elem.next().find('.layui-table td[data-field=sum] .layui-table-cell:last').text(sumTotal.toFixed(2))
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <div class = "layui-btn-container" >
                            <button class="layui-btn layui-btn-sm" onclick="xadmin.open('选择要添加的资产名称','/admin/pub/selectGoods.html?or_id=<?php echo htmlentities($or_id); ?>&ordertype=procure_return',800,600)"><i class="layui-icon"></i>选择资产</button>
