<?php /*a:2:{s:70:"/www/wwwroot/pt.mbacms.com/application/admin/view/sales/salesList.html";i:1582814810;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space8" id="ajaxForm" method="get" action="salesListJson">
                        <div class="layui-inline layui-show-xs-block">
                            <input class="layui-input" autocomplete="off" placeholder="开始日" name="start" id="start"></div>
                        <div class="layui-inline layui-show-xs-block">
                            <input class="layui-input" autocomplete="off" placeholder="截止日" name="end" id="end"></div>
                <div class="layui-input-inline">
                    <select lay-filter="aihao" name="or_shop" lay-verify="required">
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table id="lotus-table"  lay-data="{page:true,limits:[20,50,100],loading:true,toolbar:'#toolbarDemo',url:'salesListJson',hash:''}"  class="layui-table layui-hide" lay-filter="lotus-table">
                        <thead>
                        <tr>
                            ...
                            <th lay-data="{field:'member_name',width:'16%',align:'center'}">职员</th>
                            <th lay-data="{field:'supplier_name'},width:'16%',align:'center'}">供应商</th>
                    ...
                    <script type="text/html" id="finishTpl">
                      ...
                      <span class="layui-badge layui-bg-green">已完成</span>
                        {{# }else{ }}
                        <button class="layui-badge layui-btn layui-btn-sm" onclick="lotus.verifyOrder('{{d.id}}','/admin/pub/finishOrder?ordertype=collection')" title="点击完成时会处理出库状态">未完成</button>
                      {{# } }}
                    </script>
...
<script>
    $('.lotus-search-btn').on('click',function () {
        var where = {
            ...
            or_shop:$('select[name=or_shop]').val(),
