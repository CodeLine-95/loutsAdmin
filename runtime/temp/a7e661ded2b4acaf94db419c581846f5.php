<?php /*a:2:{s:71:"/www/wwwroot/pt.mbacms.com/application/admin/view/storage/seeOrder.html";i:1584373440;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="layui-col-md12" style="height:80px;line-height:80px;text-align:center;font:bold 18px 黑体;"><h2><?php echo htmlentities($site_config['site_name']); ?><?php echo htmlentities($title); ?></h2></div>
                    <form class="layui-form layui-col-space8" method="post" id="lotus-sigle-edit-form" lay-filter="lotus-form-filter">
                        <div class="layui-row">
                            ...
                            <div class="layui-input-inline" style="width:120px;">
                                <input type="text" class="layui-input" readonly="readonly" name="supplier_name" style="border:0;">
                        </div>
                    </div>
                    ...
                    <div class="layui-row">
                            ...
                            <div class="layui-input-inline" style="width:150px;">
                            <input type="text" name="or_verify_user" autocomplete="off" class="layui-input" readonly="readonly" style="border:0;">
                        </div>
                    </div>
                        ...
                        <div class="layui-input-inline" style="width:120px;">
                            <input class="layui-input" name="or_depart" readonly="readonly" style="border:0;">
                        </div>
                    </div>
                    </div>
                    </form>
...
<script>
    var lotusFormVal = {
        ...
        'supplier_name':"<?php echo htmlentities($data['supplier_name']); ?>",
        ...
        'or_verify_user':"<?php echo htmlentities($data['or_verify_user']); ?>",
        'or_depart':"<?php echo htmlentities($data['mcategory_name']); ?>"
    }
