<?php /*a:2:{s:71:"/www/wwwroot/pt.mbacms.com/application/admin/view/sales/returnList.html";i:1583921610;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table id="lotus-table"  lay-data="{page:true,limits:[20,50,100],loading:true,toolbar:'#toolbarDemo',url:'returnListJson',hash:''}"  class="layui-table layui-hide" lay-filter="lotus-table">
                        <thead>
                        <tr>
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <button class="layui-btn layui-btn-sm layui-btn-normal" lay-event="getCheckPay"><i class="layui-icon layui-icon-rmb"></i>组合付款</button>
                    </script>
                    ...
                    <script type="text/html" id="actionTpl">
                        <button onclick="xadmin.open('查看退货订单','seeOrder.html?or_id={{d.or_id}}&ordertype=<?php echo htmlentities($ordertype); ?>',900,600)" class="layui-btn  layui-btn-xs layui-btn-normal">查看</button>
                        {{#  if(d.or_finish==0){  }}
                        <button onclick="xadmin.open('编辑退货订单','editReturn.html?or_id={{d.or_id}}',900,600)" class="layui-btn  layui-btn-xs">编辑</button>
                        {{#  } }}
