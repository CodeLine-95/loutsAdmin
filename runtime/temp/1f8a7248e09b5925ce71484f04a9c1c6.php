<?php /*a:2:{s:73:"/www/wwwroot/pt.mbacms.com/application/admin/view/storage/addStorage.html";i:1587103754;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form layui-col-space8" method="post" id="lotus-sigle-edit-form" action="addStorage" lay-filter="lotus-form-filter">
                    <div class="layui-row">
                   ...
                   <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width:100px;">
                                <select class="layui-select" name="or_depart" lay-filter="hc_select" autocomplete="off" lay-search lay-verify="required">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width:100px;">
                                <select class="layui-select" name="or_project" lay-filter="hc_select" autocomplete="off" lay-search>
                    ...
                    <div class="layui-row">
                    	<div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width:100px;">
                                <select class="layui-select" name="or_verify_user" lay-filter="hc_select" autocomplete="off" lay-search lay-verify="required">
...
this.elem.next().find('.layui-table td[data-field=sum] .layui-table-cell:last').text(sumTotal.toFixed(2))
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <div class = "layui-btn-container" >
                            <button class="layui-btn layui-btn-sm" onclick="xadmin.open('选择要添加的资产名称','/admin/pub/selectGoods.html?or_id=<?php echo htmlentities($or_id); ?>&ordertype=procure',800,600)"><i class="layui-icon"></i>选择资产</button>
