<?php /*a:2:{s:71:"/www/wwwroot/pt.mbacms.com/application/admin/view/estate/tools/add.html";i:1588909438;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <form class="layui-form layui-form-pane" id="lotus-add-form" action="add" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="default_id" id="default_id" lay-verify="required" class="layui-select" lay-search>
	                    ...
	                    <option value="<?php echo htmlentities($t['id']); ?>"><?php echo htmlentities($t['tools_name']); ?></option>
	                   <?php endforeach; ?>
	                </select>
                </div>
            </div>
            ...
            <div class="layui-form-item" id="times" style="display:none;">
        		<div class="layui-col-md3">
	                ...
	                <div class="layui-input-inline">
	                    <input type="text" name="start_time" id="start" lay-verify="required" autocomplete="off" value="<?php echo date('Y-m-d'); ?>" class="layui-input">
	                </div>
        		</div>
        		<div class="layui-col-md3">
        			<label class="layui-form-label">结束时间</label>
	                <div class="layui-input-inline">
	                    <input type="text" name="end_time" id="end" lay-verify="required" autocomplete="off" value="<?php echo date('Y-m-d'); ?>" class="layui-input">
	                </div>
        		</div>
