<?php /*a:2:{s:68:"/www/wwwroot/pt.mbacms.com/application/admin/view/index/welcome.html";i:1584245223;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
                    ...
                    <ul class="layui-row layui-col-space10 layui-this x-admin-carousel x-admin-backlog">
                        <li class="layui-col-md3 layui-col-xs6">
                            <a href="javascript:;" onclick="xadmin.add_tab('商品管理','/index.php/admin/goods/goodslist.html')" class="x-admin-backlog-body">
                                <h3>资产类别</h3>
                                <p><cite><?php echo htmlentities($topData['goodsNumbers']); ?></cite></p>
                            </a>
                        </li>
                        <li class="layui-col-md3 layui-col-xs6">
                            <a href="javascript:;" class="x-admin-backlog-body">
                                <h3>职员人数</h3>
                                <p><cite><?php echo htmlentities($topData['memberNumbers']); ?></cite></p>
                            </a>
                        </li>
                        <li class="layui-col-md3 layui-col-xs6">
                            <a href="javascript:;" class="x-admin-backlog-body">
                                <h3>出库数量</h3>
                                <p><cite><?php echo htmlentities($topData['orderNumbers']); ?></cite></p>
                            </a>
                        </li>
                        <li class="layui-col-md3 layui-col-xs6">
                            <a href="javascript:;" class="x-admin-backlog-body">
                                <h3>库存总数</h3>
                                <p><cite><?php echo htmlentities($topData['stockNumbers']); ?></cite></p>
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="col-lg-3" style="width:20%;float:right;">
                            <ul class="stat-list">
                                <li>
                                    ...
                                    <small>{{precyclename}}出库额</small>
                                </li>
                                <li>
                                    <h2 class="no-margins ">{{cycleprice}}</h2>
                                    <small>{{cyclename}}出库额</small>
                                ...
                                <li>
                                    ...
                                    <small>{{precyclename}}采购总数</small>
                                </li>
                                <li>
                                    <h2 class="no-margins">{{cyclecount}}</h2>
                                    <small>{{cyclename}}采购总数</small>
                ...
                <div class="layui-card-body ">
                    <table class="layui-table">
                        ...
                        <tr>
                            <th>版权所有</th>
                            <td>
                                <a href="https://www.agzjt.com" target="_blank">安光正集团</a></td>
                        </tr>
                        <tr>
                            <th>技术支持</th>
                            <td>QQ：3532111</td>
                        ...
                        <tr>
                            <th>后台操作过程中如有问题:</th>
                            <td><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3532111&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:3532111:51" alt="点击这里给我发消息" title="联系技术工程师"/></a></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
