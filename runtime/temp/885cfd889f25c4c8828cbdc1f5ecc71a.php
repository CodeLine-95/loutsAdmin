<?php /*a:2:{s:70:"/www/wwwroot/pt.mbacms.com/application/admin/view/estate/car/edit.html";i:1587542336;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <form class="layui-form layui-form-pane" id="lotus-edit-form" action="edit" method="post">
            ...
            <div class="layui-form-item">
                ...
                <label class="layui-form-label">车位号</label>
                    ...
                    <input type="text" name="car_parking" value="<?php echo htmlentities($field['car_parking']); ?>" lay-verify="required" autocomplete="off" class="layui-input">
                     </div>
                </div>	
            	...
            	<div class="layui-col-md3">
	                ...
	                <div class="layui-input-inline">
	                    <div class="layui-input-inline">
                        <input type="text"  name="car_no" value="<?php echo htmlentities($field['car_no']); ?>" autocomplete="off" class="layui-input">
                        </div>
	                </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <label class="layui-form-label">车辆名称</label>
                      <div class="layui-input-inline">
                    <input type="text" name="car_name" value="<?php echo htmlentities($field['car_name']); ?>" lay-verify="required" autocomplete="off" class="layui-input">
                     </div>
                </div>	
            	...
            	<div class="layui-col-md3">
	                ...
	                <div class="layui-input-inline">
	                    <select name="car_type" id="car_type" class="layui-select" lay-search>
	                		<option value="1" <?php if($field['car_type'] == 1): ?> selected <?php endif; ?>>蓝色车牌</option>
	                		<option value="2" <?php if($field['car_type'] == 2): ?> selected <?php endif; ?>>黄色车牌</option>
	                		<option value="3" <?php if($field['car_type'] == 3): ?> selected <?php endif; ?>>绿色车牌</option>
	                    </select>
	                </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
        		<div class="layui-col-md3">
	                ...
	                <div class="layui-input-inline">
	                    <input type="text"  name="car_username" value="<?php echo htmlentities($field['car_username']); ?>" lay-verify="required" autocomplete="off" class="layui-input">
	                </div>
        		</div>
        		<div class="layui-col-md3">
        			<label class="layui-form-label">联系电话</label>
	                <div class="layui-input-inline">
	                    <input type="text"  name="car_tel" value="<?php echo htmlentities($field['car_tel']); ?>" lay-verify="required|phone" autocomplete="off" class="layui-input">
	                </div>
        		</div>
            </div>
            ...
            <div class="layui-form-item">
        		<div class="layui-col-md3">
	                ...
	                <div class="layui-input-inline">
	                    <input type="text"  name="car_start_time" value="<?php echo htmlentities($field['car_start_time']); ?>" id="start" lay-verify="required" autocomplete="off" class="layui-input">
	                </div>
        		</div>
        		<div class="layui-col-md3">
        			<label class="layui-form-label">到期时间</label>
	                <div class="layui-input-inline">
	                    <input type="text"  name="car_end_time" value="<?php echo htmlentities($field['car_end_time']); ?>" id="end" lay-verify="required" autocomplete="off" class="layui-input">
	                </div>
        		</div>
            </div>
