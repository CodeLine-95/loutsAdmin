<?php /*a:2:{s:68:"/www/wwwroot/pt.mbacms.com/application/admin/view/user/editRule.html";i:1566110242;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
...
<div class="layui-fluid lotus-form">
    <div class="layui-row">
        <form class="layui-form layui-form-pane"  lay-filter="lotus-form-filter" id="lotus-edit-form" action="editRule" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text"  name="name" lay-verify="required"  placeholder="例如:admin/user/userList"  value=""  autocomplete="off" class="layui-input">
                </div>
            </div>
...
<script>
    var lotusFormVal = {
        ...
        'pid':"<?php echo htmlentities($data['pid']); ?>",
        "name":"<?php echo htmlentities($data['name']); ?>",
        'title':"<?php echo htmlentities($data['title']); ?>",
        'icon':"<?php echo htmlentities($data['icon']); ?>",
        'sort':"<?php echo htmlentities($data['sort']); ?>",
