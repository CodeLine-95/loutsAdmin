<?php /*a:2:{s:70:"/www/wwwroot/pt.mbacms.com/application/admin/view/sales/addReturn.html";i:1584528212;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form layui-col-space8" method="post" id="lotus-sigle-edit-form" action="addReturn" lay-filter="lotus-form-filter">
                        <div class="layui-row">
...
this.elem.next().find('.layui-table td[data-field=sum] .layui-table-cell:last').text(sumTotal.toFixed(2))
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <div class = "layui-btn-container" >
                            <button class="layui-btn layui-btn-sm" onclick="xadmin.open('选择将要【退回仓库】的资产','/admin/pub/selectGoods.html?or_id=<?php echo htmlentities($or_id); ?>&ordertype=sales_return',800,600)"><i class="layui-icon"></i>选择资产</button>
