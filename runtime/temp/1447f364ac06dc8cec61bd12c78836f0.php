<?php /*a:3:{s:69:"/www/wwwroot/pt.mbacms.com/application/admin/view/report/procure.html";i:1582476158;s:68:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/container.html";i:1580970374;s:69:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/buildchart.html";i:1581074326;}*/ ?>
<!doctype html>
...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-row layui-col-space15">
            ...
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">采购资产排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo htmlentities($limit); ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            <thead>
                            <tr>
