<?php /*a:2:{s:75:"/www/wwwroot/pt.mbacms.com/application/admin/view/storage/storagetotal.html";i:1587021452;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
            ...
            <div class="layui-card">
                    ...
                    <form class="layui-form layui-col-space8" id="ajaxForm" method="get" >
                        ...
                        <div class="layui-inline layui-show-xs-block">
                        	<select name="or_depart" id="or_depart" class="layui-select">
                        		...
                        		<?php foreach($mcategory as $m): ?>
                        		<option value="<?php echo htmlentities($m['id']); ?>"><?php echo htmlentities($m['mcategory_name']); ?></option>
                        		<?php endforeach; ?>
                        	</select>
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                        	<select name="userid" id="userid" class="layui-select">
                        		...
                        		<?php foreach($user_ext as $u): ?>
                        		<option value="<?php echo htmlentities($u['userid']); ?>"><?php echo htmlentities($u['fullname']); ?></option>
                        		<?php endforeach; ?>
                        	</select>
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                        	<select name="or_project" id="or_project" class="layui-select">
                        		...
                        		<?php foreach($project as $o): ?>
                        		<option value="<?php echo htmlentities($o['id']); ?>"><?php echo htmlentities($o['project_name']); ?></option>
                        		<?php endforeach; ?>
                        	</select>
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    ...
                    <script type="text/html" id="actionTpl">
                        <button onclick="xadmin.open('查看采购订单','seeOrder.html?or_id={{d.or_id}}&ordertype=<?php echo htmlentities($ordertype); ?>',900,600)" class="layui-btn  layui-btn-xs layui-btn-normal">查看</button>
                        {{#  if(d.or_finish==0){  }}
