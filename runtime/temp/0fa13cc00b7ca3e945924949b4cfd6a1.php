<?php /*a:3:{s:67:"/www/wwwroot/pt.mbacms.com/application/admin/view/report/sales.html";i:1582476431;s:68:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/container.html";i:1580970374;s:69:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/buildchart.html";i:1581074326;}*/ ?>
<!doctype html>
...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">出库金额统计</div>
                <div class="layui-card-body layui-row">
                    <div class="layui-col-md12">
                        <div class="layui-btn-container" ref="echarts_sales" style="height:300px"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">楼宇用量饼状图</div>
                <div class="layui-card-body layui-row">
                    <div class="layui-col-md12">
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">职员用量排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo htmlentities($limit); ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            ...
                            <tbody>
                                <?php if(is_array($salesList) || $salesList instanceof \think\Collection || $salesList instanceof \think\Paginator): $i = 0; $__LIST__ = $salesList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
            ...
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">资产用量排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo htmlentities($limit); ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            <thead>
                            <tr>
        ...
        new Vue({
            ...
            methods:{
                getBusinesHeade:function(){
                    var that=this;
                    layList.baseGet(layList.Url({a:'getBusinesHeade',q:{data:this.data,type:'sales'}}),function (rem) {
                        that.badge=rem.data;
                    });
                },
                getBusinesChart:function(){
                    var that=this;
                    layList.baseGet(layList.Url({a:'getBusinesChart',q:{data:this.data,type:'sales'}}),function (rem) {
                        ...
                        var shop=that.setoption(rem.data.shop_data,rem.data.shop_xdata,null,'楼宇用量饼状图','pic','');
                        that.myChart.shop.setOption(shop);
                    });
                },
                setoption:function(seriesdata,xdata,legend,title,type,Zoom){
                    var _type=type || 'line';
                    var _title=title || '出库金额趋势图';
                    switch (_type){
                        case 'line':
                            this.option={
            ...
            mounted:function () {
                this.setChart(this.$refs.echarts_sales,'list');
