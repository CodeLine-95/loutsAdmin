<?php /*a:2:{s:74:"/www/wwwroot/pt.mbacms.com/application/admin/view/storage/editStorage.html";i:1587544474;s:64:"/www/wwwroot/pt.mbacms.com/application/admin/view/pub/modal.html";i:1580923564;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form layui-col-space8" method="post" id="lotus-edit-form" action="editStorage?verify_status_old=<?php echo htmlentities($verify_status); ?>" lay-filter="lotus-form-filter">
                        <div class="layui-row">
		                   ...
		                   <div class="layui-inline">
	                    	...
	                    	<div class="layui-inline">
	                            ...
	                            <div class="layui-input-inline" style="width:100px;">
	                                <select class="layui-input" name="or_depart" autocomplete="off" lay-search lay-verify="required">
                    	...
                    	<div class="layui-row">
                    		<div class="layui-inline">
	                            ...
	                            <div class="layui-input-inline" style="width:100px;">
	                                <select class="layui-input" name="or_project" autocomplete="off" lay-search >
	                                    <?php if(is_array($project) || $project instanceof \think\Collection || $project instanceof \think\Paginator): $i = 0; $__LIST__ = $project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	                                        <option value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['project_name']); ?></option>
	                                    <?php endforeach; endif; else: echo "" ;endif; ?>
	                                </select>
	                            </div>
	                        </div>
                    		<div class="layui-inline">
	                            ...
	                            <div class="layui-input-inline" style="width:100px;">
	                                <select class="layui-input" name="or_verify_user" autocomplete="off" lay-search lay-verify="required">
...
this.elem.next().find('.layui-table td[data-field=sum] .layui-table-cell:last').text(sumTotal.toFixed(2))
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <div class = "layui-btn-container" >
                            ...
                            <button class="layui-btn layui-btn-sm" onclick="xadmin.open('选择要添加的商品','/admin/pub/selectGoods.html?or_id=<?php echo htmlentities($or_id); ?>&ordertype=procure',800,600)"><i class="layui-icon"></i>选择资产</button>
                            {{# } }}
                        </div >
                    </script>
...
<script>
    var lotusFormVal = {
        ...
        'or_depart':"<?php echo htmlentities($orders['or_depart']); ?>",
        'or_project':"<?php echo htmlentities($orders['or_project']); ?>",
        'or_verify_user':"<?php echo htmlentities($orders['or_verify_user']); ?>",
    }
