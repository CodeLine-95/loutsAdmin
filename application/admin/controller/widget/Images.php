...
//       $this->assign(compact('typearray'));
    ...
    public function deleteimganddata($att_id){
        $attinfo = SystemAttachmentModel::where('att_id',$att_id)->find();//->toArray();
        if($attinfo){
    ...
    public function moveimg($imgaes){
        ...
        $form = Form::make_post_form('编辑分类',$formbuider,Url('moveImgCecate'));
    ...
    public function addcate($id){
        ...
        $form = Form::make_post_form('添加分类',$formbuider,Url('saveCate'));
        $this->assign(compact('form'));
        return $this->fetch('pub/form-builder');
    }
    /**
    ...
    public function editcate($id){
        ...
        $form = Form::make_post_form('编辑分类',$formbuider,Url('updateCate'));
        $this->assign(compact('form'));
        return $this->fetch('pub/form-builder');
    }
    /**
